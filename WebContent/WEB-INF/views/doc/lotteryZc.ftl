...
<div class="mright">
    ...
    <table width="790" border="0" cellpadding="0" cellspacing="0" class="tb1" style="line-height:28px;">
     ...
     <div class="k10"></div>
      <div class="bgtitlec">玩法类型</div>
      <table width="790" border="0" cellpadding="0" cellspacing="0" class="tb1" style="line-height:28px;">
        <tr class="tdtitle">
	        <td width="100" class="doc_td_head_1">对应投注</td>
	        <td width="220" class="doc_td_other">value 值</td>

      </tr>
      <#if lottery.playTypeItem??&& (lottery.playTypeItem![])?size gt 0>
	   
 		 <#assign data = lottery.playTypeItem[0]>
	    	<tr class="tdwhitelist" onmouseover="this.className='trhover'" onmouseout="this.className='tdwhitelist'">
	    	    <td class="doc_td_head_1">胆拖</td>
		        <td class="doc_td_other">${data.danValue!}</td>
		        
	    	</tr>
	    	  	<tr class="tdwhitelist" onmouseover="this.className='trhover'" onmouseout="this.className='tdwhitelist'">
	    	    <td class="doc_td_head_1">复式</td>
		        <td class="doc_td_other">${data.compoundValue!}</td>
 
	    	</tr>
	    	  	<tr class="tdwhitelist" onmouseover="this.className='trhover'" onmouseout="this.className='tdwhitelist'">
	    	    <td class="doc_td_head_1">单式</td>
		        <td class="doc_td_other">${data.singleValue!}</td>
