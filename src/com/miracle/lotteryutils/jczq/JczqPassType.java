 ...
 * 
 */
public enum JczqPassType implements PassTypeItem {
	/** 单关 */
	P1(1, new int[] { 1 },"01") {
	 ...
	 *            过关的场次数目数组
	 */
	private JczqPassType(int matchCount, int[] passMatchs,String cpText) {
	...
	public static List<JczqPassType> findPassTypes(int pass, int maxMatchSize) {
		List<JczqPassType> list = new ArrayList<JczqPassType>();
		for (JczqPassType passType : JczqPassType.values()) {
	 ...
	 * @return 过关方式类型
	 */
	public static JczqPassType valueOfType(String typeName) {
		if (StringUtils.isNotBlank(typeName)) {
			for (JczqPassType spPassType : values()) {
	 ...
	 * @return 过关方式类型
	 */
	public static JczqPassType getSpPassType(long value) {
		for (JczqPassType spPassType : values()) {
	 ...
	 * @return 过关方式类型集合
	 */
	public static List<JczqPassType> getPassTypes(long mixPtValue) {
		List<JczqPassType> sets = Lists.newArrayList();
		for (JczqPassType spPassType : values()) {
