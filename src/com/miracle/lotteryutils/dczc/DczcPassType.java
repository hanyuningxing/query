 ...
 * 
 */
public enum DczcPassType implements PassTypeItem {
	/** 单关 */
	P1(new int[] { 1 })  ,
	 ...
	 */
	private DczcPassType(int[] passMatchs) {
		this(-1, passMatchs);
	}
	 ...
	 * @param passMatchs 过关的场次数目数组
	 */
	private DczcPassType(int index, int[] passMatchs) {
	 ...
	 * @param passMatchs 过关的场次数目数组
	 */
	private DczcPassType(int index, int matchCount, int[] passMatchs) {
		if (index < 0)
			index = this.ordinal();
	 ...
	 * @return 过关方式类型
	 */
	public static DczcPassType valueOfType(String typeName) {
		if (typeName != null && !typeName.trim().equals("")) {
			for (DczcPassType spPassType : values()) {
	 ...
	 * @return 过关方式类型
	 */
	public static DczcPassType getPassType(int value) {
		for (DczcPassType spPassType : values()) {
	 ...
	 * @return 过关方式类型集合
	 */
	public static List<DczcPassType> getPassTypes(int mixPtValue) {
		List<DczcPassType> sets = new ArrayList<DczcPassType>();
		for (DczcPassType spPassType : values()) {
