package com.miracle.lotteryutils.sde11to5;

import com.miracle.lotteryutils.Item;
import com.miracle.lotteryutils.PlayTypeItem;

public enum Sdel11to5PlayType implements PlayTypeItem{
	...
	private Sdel11to5PlayType(String typeName,Boolean compoundSupport, Boolean singleSupport,Boolean danSupport,String compoundValue,String singleValue,String danValue) {
