...
@Entity
@Table(name = Constant.LOTTERY_TABLE_PREFIX + "DCZC_ODDS")
public class DczcOdds extends IdEntity{
	...
	private Lottery lotteryType;
		...
		public static String toOddsArray(List<DczcOdds> oddsList){
			StringBuilder sb=new StringBuilder();
			sb.append("[");
			String str="";
			for(DczcOdds o:oddsList){		 
