...
import com.miracle.common.TicketSupporter;
import com.miracle.lotteryutils.Lottery;
import com.miracle.model.IdEntityWithTimeFlag;

@Table(name = Constant.LOTTERY_TABLE_PREFIX + "TICKET_THEN")
@Entity
public class TicketThen extends IdEntityWithTimeFlag {

	private static final long serialVersionUID = -1599949545179101603L;
	...
	public void setTotalPrizeAfterTax(final BigDecimal totalPrizeAfterTax) {
	...
	public void setPrizeTime(final Date prizeTime) {
	...
	public void setStateModifyTime(final Date stateModifyTime) {
	...
	public void setAddPrize(final BigDecimal addPrize) {
	...
	public void setState(final TicketSchemeState state) {
		this.state = state;
	}
	...
	public void setPlatformInfoId(final Long platformInfoId) {
