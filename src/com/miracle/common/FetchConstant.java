...
public class FetchConstant {
	...
	//胜负彩
	public static final String SFCURL="http://odds.552cai/index.php?controller=sfcodds&action=index&tp=1";
	//进球彩
	public static final String JQCURL="http://odds.552cai/index.php?controller=jqodds&action=index&tp=3";
	//半全场
	public static final String BQCURL="http://odds.552cai/index.php?controller=bqodds&action=index&tp=4";

	public static final String XYO_URL = "http://odds.552cai/index.php?controller=bdodds&action=index&tp=5";
	...
	public static final String CURPERIOD_URL = "http://www.552cai.com/ch/dczc.htm";
	//过滤的最大条目
